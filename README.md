# Express & mongoose REST API Boilerplate in ES6 with Code Coverage and Swagger Documentation

## Overview
Fork of [express-mongoose-es6-rest-api](https://github.com/KunalKapadia/express-mongoose-es6-rest-api)
with the JWT authorization associated with database (model User) and integrated Swagger Documentation.
...
```
Swagger api file: **./server/swagger.yaml**

You can use [Swagger Online Editor](https://editor.swagger.io/) to edit API Documentation.
